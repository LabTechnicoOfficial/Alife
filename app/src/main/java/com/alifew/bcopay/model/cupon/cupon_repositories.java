...
public class cupon_repositories {
    ...
    public MutableLiveData<add_response> addCupon(String shop_id, String cupon_name, String time_range, String create_date, String end_date, String description) {
        ...
        call.enqueue(new Callback<com.alifew.bcopay.model.cupon.add_response>() {
            @Override
            public void onResponse(Call<com.alifew.bcopay.model.cupon.add_response> call, Response<com.alifew.bcopay.model.cupon.add_response> response) {
                if (response.isSuccessful())
                    add_response.postValue(response.body());
            }

            @Override
            public void onFailure(Call<com.alifew.bcopay.model.cupon.add_response> call, Throwable throwable) {
