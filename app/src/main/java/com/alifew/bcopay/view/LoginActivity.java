...
import com.alifew.bcopay.model.Shop_login_response;
            ...
            public void onChanged(Shop_login_response shop_login_response) {
                ...
                if (id.equals("35")) {
                    ...
                    if (!id.equals("-1")) {
                        ...
                        otp.getStatus(phone, "Your shopkeeper login OTP code is -" + random_otp + " " + ". Powered by "+getApplication().getString(R.string.app_name)).observe(LoginActivity.this, new Observer<OTP_response>() {
                            @Override
            ...
            public void onChanged(Shop_login_response shop_login_response) {
                ...
                if (id.equals("457")) {
                    ...
                    if (!id.equals("-1")) {
                        ...
                        otp.getStatus(phone, "Your customer login OTP code is -" + random_otp + " " + ". Powered by "+getApplication().getString(R.string.app_name)).observe(LoginActivity.this, new Observer<OTP_response>() {
                            @Override
                            public void onChanged(OTP_response otp_response) {
                                dialog.dismiss();
                                if (otp_response.getStatus().equals("queued")) {
