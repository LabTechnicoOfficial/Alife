...
import com.alifew.bcopay.model.get_product_repositories;
...
public class Get_product extends ViewModel {
    ...
    public LiveData<Fetch_product_detail_by_bar_code_response> fetch_product_detail_by_bar_code(String shopID, String code) {
        return get_product_repositories.getInstance().get_product_detail_by_bar_code(shopID, code);
