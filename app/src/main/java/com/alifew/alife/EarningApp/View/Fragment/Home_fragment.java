...
import com.alifew.alife.EarningApp.Adapter.Notice_adapter;
import com.alifew.alife.EarningApp.Model.AddLimit.addLimit_response;
import com.alifew.alife.EarningApp.Model.AddLimit.update_addLimit_response;
...
import com.alifew.alife.EarningApp.Model.addRequest.Add_request;
import com.alifew.alife.EarningApp.Model.addRequest.add_request_response;
import com.alifew.alife.EarningApp.ViewModel.AddLimit;
import com.alifew.alife.EarningApp.ViewModel.NoticeViewModel;
import com.alifew.alife.EarningApp.ViewModel.ProfileViewModel;
import com.alifew.alife.EarningApp.ViewModel.RewardViewModel;
import com.alifew.alife.EarningApp.ViewModel.VideoADViewModel;
                    ...
                    public void onChanged(Message_response message_response) {
                        ...
                        if (message.equals("ok")) {
                            addLimit.getResponse(userID).observe(getViewLifecycleOwner(), new Observer<update_addLimit_response>() {
                                ...
                                public void onChanged(update_addLimit_response update_addLimit_response) {
                                    Toast.makeText(getActivity(), "Reward added", Toast.LENGTH_SHORT).show();
                                    add_request.updateData(userID).observe(getViewLifecycleOwner(), new Observer<com.alifew.alife.EarningApp.Model.addRequest.add_request_response>() {
                                        @Override
                                        public void onChanged(com.alifew.alife.EarningApp.Model.addRequest.add_request_response add_request_response) {
                                            // profile();
                                            //
                                            Earning_Session_Management earning_session_management = new Earning_Session_Management(getActivity());
                                            type = earning_session_management.getType();
