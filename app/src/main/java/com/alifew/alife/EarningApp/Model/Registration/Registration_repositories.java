...
public class Registration_repositories {
    ...
    public @NonNull
    MutableLiveData<String> getMessage(@NonNull String name, @NonNull String phone, @NonNull String mail, @NonNull String area, @NonNull String referCode, @NonNull String password) {
        if (message == null) {
            message = new MutableLiveData<>();
        }
        Call<String> call = registration_api.saveUser(name, phone, mail, area, referCode, password);
