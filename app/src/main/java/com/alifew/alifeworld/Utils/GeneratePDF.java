...
public class GeneratePDF {
    ...
    public static com.gkemon.XMLtoPDF.PdfGenerator.ContextStep getBuilder() {
        return new com.gkemon.XMLtoPDF.PdfGenerator.Builder();
    }
    ...
    public interface ContextStep {
        com.gkemon.XMLtoPDF.PdfGenerator.FromSourceStep setContext(Context context);
    }

    public interface FromSourceStep {
        com.gkemon.XMLtoPDF.PdfGenerator.LayoutXMLSourceIntakeStep fromLayoutXMLSource();

        com.gkemon.XMLtoPDF.PdfGenerator.ViewIDSourceIntakeStep fromViewIDSource();

        com.gkemon.XMLtoPDF.PdfGenerator.ViewSourceIntakeStep fromViewSource();
    }


    public interface ViewSourceIntakeStep {
        com.gkemon.XMLtoPDF.PdfGenerator.FileNameStep fromView(View... viewList);
        com.gkemon.XMLtoPDF.PdfGenerator.FileNameStep fromViewList(List<View> viewList);
    }

    public interface LayoutXMLSourceIntakeStep {
        com.gkemon.XMLtoPDF.PdfGenerator.FileNameStep fromLayoutXML(@LayoutRes Integer... layoutXMLs);
        com.gkemon.XMLtoPDF.PdfGenerator.FileNameStep fromLayoutXMLList(@LayoutRes List<Integer> layoutXMLList);
    }
    ...
    public interface ViewIDSourceIntakeStep {
         ...
         * @return
         */
        com.gkemon.XMLtoPDF.PdfGenerator.FileNameStep fromViewID(@LayoutRes Integer relatedParentLayoutID, Activity activity, @IdRes Integer... xmlResourceList);
        com.gkemon.XMLtoPDF.PdfGenerator.FileNameStep fromViewIDList(@LayoutRes Integer relatedParentLayoutID, Activity activity, @IdRes List<Integer> xmlResourceList);
    ...
    public interface PageSizeStep {
        com.gkemon.XMLtoPDF.PdfGenerator.FileNameStep setPageSize(com.gkemon.XMLtoPDF.PdfGenerator.PageSize pageSize);
    }


    public interface FileNameStep {
        com.gkemon.XMLtoPDF.PdfGenerator.Build setFileName(String fileName);
    }

    public interface Build {
        void build(PdfGeneratorListener pdfGeneratorListener);

        com.gkemon.XMLtoPDF.PdfGenerator.Build setFolderName(String folderName);

        com.gkemon.XMLtoPDF.PdfGenerator.Build openPDFafterGeneration(boolean open);

    }


    public static class Builder implements com.gkemon.XMLtoPDF.PdfGenerator.Build, com.gkemon.XMLtoPDF.PdfGenerator.FileNameStep, com.gkemon.XMLtoPDF.PdfGenerator.PageSizeStep
            , com.gkemon.XMLtoPDF.PdfGenerator.LayoutXMLSourceIntakeStep, com.gkemon.XMLtoPDF.PdfGenerator.ViewSourceIntakeStep, com.gkemon.XMLtoPDF.PdfGenerator.ViewIDSourceIntakeStep
            , com.gkemon.XMLtoPDF.PdfGenerator.FromSourceStep, com.gkemon.XMLtoPDF.PdfGenerator.ContextStep {
        ...
        private com.gkemon.XMLtoPDF.PdfGenerator.PageSize pageSize;
        ...
        private void resetValue() {
            if (pageSize != null) {
                if (pageSize == com.gkemon.XMLtoPDF.PdfGenerator.PageSize.A4) {
                    pageHeightInPixel = a4HeightInPX;
                    pageWidthInPixel = a4WidthInPX;
                } else if (pageSize == com.gkemon.XMLtoPDF.PdfGenerator.PageSize.A5) {
                    pageHeightInPixel = a5HeightInPX;
                    pageWidthInPixel = a5WidthInPX;
                } else if (pageSize == com.gkemon.XMLtoPDF.PdfGenerator.PageSize.WRAP_CONTENT) {
        ...
        private void print() {
            ...
            try {
                if (context != null) {
                    ...
                    Log.d("pdfxx", "path: "+directoryPath);
                    ...
                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                        disposable = Completable.fromAction(() -> document.writeTo(Files.newOutputStream(filePath.toPath())))
                ...
                //postFailure(e);
                Log.d("pdfxx", "print: "+e.getMessage());
            }
        ...
        @Override
        public com.gkemon.XMLtoPDF.PdfGenerator.FileNameStep fromView(View... viewArrays) {
            viewList = new ArrayList<>(Arrays.asList(viewArrays));
            return this;
        }

        @Override
        public com.gkemon.XMLtoPDF.PdfGenerator.FileNameStep fromViewList(List<View> viewList) {
        ...
        @Override
        public com.gkemon.XMLtoPDF.PdfGenerator.Build openPDFafterGeneration(boolean openPdfFile) {
        ...
        @Override
        public com.gkemon.XMLtoPDF.PdfGenerator.FromSourceStep setContext(Context context) {
            this.context = context;
            return this;
        }

        @Override
        public com.gkemon.XMLtoPDF.PdfGenerator.FileNameStep setPageSize(com.gkemon.XMLtoPDF.PdfGenerator.PageSize pageSize) {
            this.pageSize = pageSize;
            return this;
        }

        @Override
        public com.gkemon.XMLtoPDF.PdfGenerator.Build setFolderName(String folderName) {
            this.folderName = folderName;
            return this;
        }

        @Override
        public com.gkemon.XMLtoPDF.PdfGenerator.Build setFileName(String fileName) {
        ...
        @Override
        public com.gkemon.XMLtoPDF.PdfGenerator.FileNameStep fromViewID(@LayoutRes Integer relatedParentLayoutID, Activity activity, @IdRes Integer... xmlResourceList) {
            viewList = Utils.getViewListFromID(activity, relatedParentLayoutID, Arrays.asList(xmlResourceList), pdfGeneratorListener);
            return this;
        }

        @Override
        public com.gkemon.XMLtoPDF.PdfGenerator.FileNameStep fromViewIDList(@LayoutRes Integer relatedParentLayout, Activity activity, List<Integer> viewIDList) {
        ...
        @Override
        public com.gkemon.XMLtoPDF.PdfGenerator.FileNameStep fromLayoutXML(@LayoutRes Integer... layouts) {
            viewList = Utils.getViewListFromLayout(context, pdfGeneratorListener, Arrays.asList(layouts));
            return this;
        }

        @Override
        public com.gkemon.XMLtoPDF.PdfGenerator.FileNameStep fromLayoutXMLList(@LayoutRes List<Integer> layoutXMLList) {
            viewList = Utils.getViewListFromLayout(context, pdfGeneratorListener, layoutXMLList);
            return this;
        }

        @Override
        public com.gkemon.XMLtoPDF.PdfGenerator.LayoutXMLSourceIntakeStep fromLayoutXMLSource() {
            return this;
        }

        @Override
        public com.gkemon.XMLtoPDF.PdfGenerator.ViewIDSourceIntakeStep fromViewIDSource() {
            return this;
        }

        @Override
        public com.gkemon.XMLtoPDF.PdfGenerator.ViewSourceIntakeStep fromViewSource() {
            return this;
        }
    }
