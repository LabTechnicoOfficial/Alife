...
import com.alifew.alifeworld.Custom_Type.productSell_temp;
...
import com.alifew.alifeworld.adapter.selected_product_list_adapter;
...
import com.alifew.alifeworld.model.payment_method_response;
...
import com.alifew.alifeworld.viewmodel.Payment_method;
            ...
            public void onChanged(push_notification_response push_notification_response) {
                if (push_notification_response.getMessage().equals("success")) {
                    ...
                    if (customer_id.equals("0")) {
                        ...
                        push_notification.sell_notification_customer(shop_id, customer_id, String.valueOf(new DecimalFormat("##.##").format(total_price)), String.valueOf(new DecimalFormat("##.##").format(due_price))).observe(getViewLifecycleOwner(), new Observer<com.alifew.alifeworld.model.push_notification_response>() {
                            @Override
