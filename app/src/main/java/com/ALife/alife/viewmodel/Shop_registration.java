...
import com.ALife.alife.model.shop_registration_repositoris;
...
public class Shop_registration extends ViewModel {
    ...
    public LiveData<String> getmessage(String name, String owner, String location, String phone, String password, String image,String token) {
        ...
        return shop_registration_repositoris.getInstance().getMessage(name, owner, location, phone, password, image, token);
    }
}
