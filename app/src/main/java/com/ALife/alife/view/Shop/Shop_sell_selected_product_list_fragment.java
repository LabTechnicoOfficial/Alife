...
import com.ALife.alife.Custom_Type.Product_sell_offer;
...
import com.ALife.alife.adapter.Sell_success_adapter;
import com.ALife.alife.adapter.Shop_registered_customer_adapter;
...
import com.ALife.alife.adapter.selected_product_list_adapter;
...
import com.ALife.alife.viewmodel.Payment_method;
            ...
            public void onChanged(push_notification_response push_notification_response) {
                if (push_notification_response.getMessage().equals("success")) {
                    ...
                    if (customer_id.equals("0")) {
                        ...
                        push_notification.sell_notification_customer(shop_id, customer_id, String.valueOf(new DecimalFormat("##.##").format(total_price)), String.valueOf(new DecimalFormat("##.##").format(due_price))).observe(getViewLifecycleOwner(), new Observer<com.ALife.alife.model.push_notification_response>() {
                            @Override
